...
def apply_status_effects():
    global hunger, thirst, objective, insanity, health, time_until_cleared
    if guide == True:
...
def handle_events():
    ...
    if insanity > 15:
        ...
        if event == 1: # Berry Bush Encounter
                ...
                if response == 'yes':
                    if insanity > 15:
                        ...
                        if outcome == [1, 4]:
                            ...
                            objective += 5
                            print('You find a map of the nearby area which greatly increases your chance of finding your way out.')
                            break
                    else:
                        insanity += 1
            ...
            while True:
                response = input('Do you approach him? (yes/no)').lower
                if response == 'yes':
                    outcome = random.randint(1, 5)
                    if outcome == [1, 3]:
